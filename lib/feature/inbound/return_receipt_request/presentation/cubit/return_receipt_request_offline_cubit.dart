...
import 'package:wms_mobile/utilies/dialog/dialog.dart' show MaterialDialog;

class ReturnReceiptRequestOfflineCubit extends Cubit<List<dynamic>> {
  ReturnReceiptRequestOfflineCubit() : super([]) {
    loadData();
  }

  final Box box = Hive.box('return_receipt_request');
