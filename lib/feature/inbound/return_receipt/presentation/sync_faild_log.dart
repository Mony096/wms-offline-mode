...
class SyncFailLogReturnReceiptScreen extends StatelessWidget {
  const SyncFailLogReturnReceiptScreen({super.key});
  Future<void> _clearAllData(BuildContext context) async {
    ...
    context.read<ReturnReceiptFailedOfflineCubit>().clearData();
  }
  ...
  Future<void> _removeById(BuildContext context, dynamic id) async {
    ...
    // User canceled
    if (confirm != true) return;
    context.read<ReturnReceiptFailedOfflineCubit>().removeByFailId(id);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<ReturnReceiptFailedOfflineCubit, List<dynamic>>(
