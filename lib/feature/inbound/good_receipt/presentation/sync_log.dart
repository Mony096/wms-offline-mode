...
class SyncLogGoodsReceiptScreen extends StatelessWidget {
  const SyncLogGoodsReceiptScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<GoodsReceiptOfflineCubit>();
    final failed =
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(
                          color: const Color.fromARGB(255, 233, 236, 237), // border color
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Goods Receipt Type : ${record['U_LK_Type_GR'] ?? '-'}",
                              style: const TextStyle(
                            ...
                            Text(
                              "Remark : ${record['Comments'] ?? '-'}",   style: const TextStyle(fontSize: 13, color: Colors.black54), ), 
