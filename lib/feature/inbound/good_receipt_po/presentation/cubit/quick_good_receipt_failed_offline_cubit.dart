...
class QuickGoodReceiptFailedOfflineCubit extends Cubit<List<dynamic>> {
  QuickGoodReceiptFailedOfflineCubit() : super([]) {
    loadData();
  }

  final Box box = Hive.box('failed_quick_goods_recept');
