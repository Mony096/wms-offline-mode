...
class SyncLogPurchaseReturnScreen extends StatelessWidget {
  const SyncLogPurchaseReturnScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<PurchaseReturnOfflineCubit>();
    final failed =
