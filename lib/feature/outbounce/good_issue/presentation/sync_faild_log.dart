...
class SyncFailLogGoodIssueScreen extends StatelessWidget {
  const SyncFailLogGoodIssueScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<GoodIssueFailedOfflineCubit, List<dynamic>>(
