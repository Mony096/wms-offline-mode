...
class SyncFailLogDeliveryScreen extends StatelessWidget {
  const SyncFailLogDeliveryScreen({super.key});
  Future<void> _clearAllData(BuildContext context) async {
    ...
    context.read<DeliveryFailedOfflineCubit>().clearData();
  }
  ...
  Future<void> _removeById(BuildContext context, dynamic id) async {
    ...
    // User canceled
    if (confirm != true) return;
    context.read<DeliveryFailedOfflineCubit>().removeByFailId(id);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<DeliveryFailedOfflineCubit, List<dynamic>>(
