...
class DeliveryOfflineCubit extends Cubit<List<dynamic>> {
  DeliveryOfflineCubit() : super([]) {
    loadData();
  }

  final Box box = Hive.box('delivery');
  ...
  Future<void> post(DeliveryFailedOfflineCubit failCubit,
      SaleOrderOfflineCubit so, BuildContext context,
