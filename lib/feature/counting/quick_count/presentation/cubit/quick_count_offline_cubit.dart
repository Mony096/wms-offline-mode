...
class QuickCountOfflineCubit extends Cubit<List<dynamic>> {
  QuickCountOfflineCubit() : super([]) {
    loadData();
  }

  final Box box = Hive.box('quick_count');
  ...
  Future<void> post(QuickCountFailedOfflineCubit failCubit,
