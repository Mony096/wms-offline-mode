...
class QuickCountLists extends StatefulWidget {
  const QuickCountLists({super.key});

  @override
  State<QuickCountLists> createState() => _QuickCountListsState();
}

class _QuickCountListsState extends State<QuickCountLists> {
  List<dynamic> data = [];
  ...
  void initState() {
    ...
    final offlineCubit = context.read<QuickCountOfflineCubit>();
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: BlocBuilder<QuickCountOfflineCubit, List<dynamic>>(
