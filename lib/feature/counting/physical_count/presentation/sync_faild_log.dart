...
class SyncFailLogPhysicalCountScreen extends StatelessWidget {
  const SyncFailLogPhysicalCountScreen({super.key});
  Future<void> _clearAllData(BuildContext context) async {
    ...
    context.read<PhysicalCountFailedOfflineCubit>().clearData();
  }
  ...
  Future<void> _removeById(BuildContext context, dynamic id) async {
    ...
    // User canceled
    if (confirm != true) return;
    context.read<PhysicalCountFailedOfflineCubit>().removeByFailId(id);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<PhysicalCountFailedOfflineCubit, List<dynamic>>(
